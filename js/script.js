const ApiKey = "bcba94ff9bee43b182ba34f18ba315ca";
        ...
        .then(resJson => {
                ViewModal.innerHTML=`
                    <div class="card horizontal">
                        ...
                        <tr>
                        <td><b>Warna Jersey </b></td><td>${resJson.clubColors}<br></tr>
                        <tr>
                        <td><b>Alamat </b></td><td>${resJson.address}<br></tr>
                        <tr>
                        <td><b>Email </b></td><td>${resJson.email}<br></tr>
                        <tr>
                        <td><b>Nomor </b></td><td>${resJson.phone}<br></tr>
                        <tr>
                        <td><b>Website </b></td><td>${resJson.website}<br></tr>
                        </table>
                    </div>
                </div>
            </div
